# [allow (non_snake_case)] # [allow (non_camel_case_types)] # [allow (clippy :: style)] # [allow (clippy :: complexity)] # [allow (unused_braces)] # [allow (clippy :: erasing_op)] # [allow (clippy :: approx_constant)] # [allow (clippy :: eq_op)] # [allow (clippy :: cmp_owned)] # [allow (clippy :: redundant_clone)] mod slint_generatedApp {
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] struct InnerColorSchemeSelector_19 {
         r#dark_color_scheme : sp :: Property < bool > , root : sp :: OnceCell < sp :: VWeak < sp :: ComponentVTable , InnerApp >> , }
     impl InnerColorSchemeSelector_19 {
         ...
         fn init (self : :: core :: pin :: Pin < sp :: Rc < Self >> , root : & sp :: VRc < sp :: ComponentVTable , InnerApp >) {
             ...
             let _self = self_rc . as_ref () ;
             {
                 slint :: private_unstable_api :: set_property_binding ({
                     * & InnerColorSchemeSelector_19 :: FIELD_OFFSETS . r#dark_color_scheme }
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] struct InnerPalette_20 {
         root : sp :: OnceCell < sp :: VWeak < sp :: ComponentVTable , InnerApp >> , }
     impl InnerPalette_20 {
         fn new () -> :: core :: pin :: Pin < sp :: Rc < Self >> {
             sp :: Rc :: pin (Self :: default ()) }
         fn init (self : :: core :: pin :: Pin < sp :: Rc < Self >> , root : & sp :: VRc < sp :: ComponentVTable , InnerApp >) {
             # ! [allow (unused)] self . root . set (VRc :: downgrade (root)) ;
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] struct Innersearch_root_11 {
         r#root_11 : sp :: r#Empty , r#area_12 : sp :: r#TouchArea , r#rectangle_13 : sp :: r#Rectangle , r#image_14 : sp :: r#ImageItem , r#textinput_15 : sp :: r#TextInput , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ComponentVTable , Innersearch_root_11 >> , root : sp :: OnceCell < sp :: VWeak < sp :: ComponentVTable , InnerApp >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl Innersearch_root_11 {
         pub fn init (self_rc : sp :: VRcMapped < sp :: ComponentVTable , Self > , root : & sp :: VRc < sp :: ComponentVTable , InnerApp > , tree_index : u32 , tree_index_of_first_child : u32) {
             ...
             ({
                 * & Innersearch_root_11 :: FIELD_OFFSETS . r#area_12 }
            ...
            ) ;
             {
                 ...
                 + r#TouchArea :: FIELD_OFFSETS . r#height) . apply_pin (_self) , & self_rc , move | self_rc | {
                     ...
                     (sp :: LogicalLength :: new (({
                         * & Innersearch_root_11 :: FIELD_OFFSETS . r#root_11 }
             ...
             ({
                 * & Innersearch_root_11 :: FIELD_OFFSETS . r#rectangle_13 }
                 ...
                 }
             {
                 ...
                 slint :: private_unstable_api :: set_animated_property_binding (({
                     * & Innersearch_root_11 :: FIELD_OFFSETS . r#image_14 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & Innersearch_root_11 :: FIELD_OFFSETS . r#textinput_15 }
                 + r#TextInput :: FIELD_OFFSETS . r#color) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (slint :: Brush :: SolidColor (slint :: Brush :: SolidColor (if InnerColorSchemeSelector_19 :: FIELD_OFFSETS . r#dark_color_scheme . apply_pin (_self . root . get () . unwrap () . upgrade () . unwrap () . globals . global_ColorSchemeSelector_19 . as_ref ()) . get () {
            ...
            ) ;
             {
                 ...
                 + r#TextInput :: FIELD_OFFSETS . r#width) . apply_pin (_self) , & self_rc , move | self_rc | {
                     ...
                     (sp :: LogicalLength :: new (((({
                         * & Innersearch_root_11 :: FIELD_OFFSETS . r#root_11 }
                     + r#Empty :: FIELD_OFFSETS . r#width) . apply_pin (_self) . get () . get () as f64) - (10f64 as f64)) as sp :: Coord)) as _ }
                ) ;
                 }
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 }
             {
                 ...
                 + r#TextInput :: FIELD_OFFSETS . r#y) . apply_pin (_self) , & self_rc , move | self_rc | {
                     ...
                     (sp :: LogicalLength :: new (((({
                         * & Innersearch_root_11 :: FIELD_OFFSETS . r#root_11 }
                     + r#Empty :: FIELD_OFFSETS . r#height) . apply_pin (_self) . get () . get () as f64) / (3f64 as f64)) as sp :: Coord)) as _ }
                ) ;
                 }
             ({
                 * & Innersearch_root_11 :: FIELD_OFFSETS . r#area_12 }
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] struct Innerplayer_root_16 {
         r#root_16 : sp :: r#Empty , r#rectangle_17 : sp :: r#Rectangle , r#image_18 : sp :: r#ImageItem , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ComponentVTable , Innerplayer_root_16 >> , root : sp :: OnceCell < sp :: VWeak < sp :: ComponentVTable , InnerApp >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     impl Innerplayer_root_16 {
         pub fn init (self_rc : sp :: VRcMapped < sp :: ComponentVTable , Self > , root : & sp :: VRc < sp :: ComponentVTable , InnerApp > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             _self . self_weak . set (VRcMapped :: downgrade (& self_rc)) ;
             _self . root . set (VRc :: downgrade (root)) ;
             ...
             _self . tree_index_of_first_child . set (tree_index_of_first_child) ;
             ({
                 * & Innerplayer_root_16 :: FIELD_OFFSETS . r#rectangle_17 }
             + r#Rectangle :: FIELD_OFFSETS . r#background) . apply_pin (_self) . set ({
                 (slint :: Brush :: SolidColor (sp :: Color :: from_argb_encoded (2165060178f64 as u32))) as slint :: Brush }
            ) ;
             {
                 ...
                 + r#Rectangle :: FIELD_OFFSETS . r#height) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new (({
                         * & Innerplayer_root_16 :: FIELD_OFFSETS . r#root_16 }
                     + r#Empty :: FIELD_OFFSETS . r#height) . apply_pin (_self) . get () . get () as sp :: Coord)) as _ }
                ) ;
                 }
             {
             ...
             ({
                 * & Innerplayer_root_16 :: FIELD_OFFSETS . r#image_18 }
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin_drop] pub struct InnerApp {
         r#root_1 : sp :: r#WindowItem , r#rectangle_2 : sp :: r#Rectangle , r#image_3 : sp :: r#ImageItem , r#CloseArea_4 : sp :: r#TouchArea , r#image_5 : sp :: r#ImageItem , r#SettingArea_6 : sp :: r#TouchArea , r#image_7 : sp :: r#ImageItem , r#UserArea_8 : sp :: r#TouchArea , r#search_9 : Innersearch_root_11 , r#player_10 : Innerplayer_root_16 , r#root_1_showsetting : sp :: Callback < () , () > , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ComponentVTable , InnerApp >> , root : sp :: OnceCell < sp :: VWeak < sp :: ComponentVTable , InnerApp >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , globals : Globals_App , window_adapter_ : sp :: OnceCell < sp :: Rc < dyn sp :: WindowAdapter >> , }
     impl InnerApp {
         pub fn init (self_rc : sp :: VRcMapped < sp :: ComponentVTable , Self > , root : & sp :: VRc < sp :: ComponentVTable , InnerApp > , tree_index : u32 , tree_index_of_first_child : u32) {
             # ! [allow (unused)] # ! [allow (unused)] let _self = self_rc . as_pin_ref () ;
             _self . self_weak . set (VRcMapped :: downgrade (& self_rc)) ;
             ...
             _self . tree_index . set (tree_index) ;
             _self . tree_index_of_first_child . set (tree_index_of_first_child) ;
             Innersearch_root_11 :: init (VRcMapped :: map (self_rc . clone () , | x | {
             ...
             Innerplayer_root_16 :: init (VRcMapped :: map (self_rc . clone () , | x | {
            ...
            ) ;
             {
                 ...
                 + r#ImageItem :: FIELD_OFFSETS . r#colorize) . apply_pin (_self) , & self_rc , move | self_rc | {
                     ...
                     + r#TouchArea :: FIELD_OFFSETS . r#has_hover) . apply_pin (_self) . get () {
                         sp :: Color :: from_argb_encoded (4291766055f64 as u32) }
                     else {
                         (sp :: Color :: from_argb_encoded (4294967295f64 as u32)) as _ }
                    )) as _ }
                 , {
         ...
         pub fn user_init (self_rc : sp :: VRcMapped < sp :: ComponentVTable , Self >) {
             let _self = self_rc . as_pin_ref () ;
             Innersearch_root_11 :: user_init (VRcMapped :: map (self_rc . clone () , | x | {
                 * & Self :: FIELD_OFFSETS . r#search_9 }
             . apply_pin (x)) ,) ;
             Innerplayer_root_16 :: user_init (VRcMapped :: map (self_rc . clone () , | x | {
                 * & Self :: FIELD_OFFSETS . r#player_10 }
             . apply_pin (x)) ,) ;
             }
         fn visit_dynamic_children (self : :: core :: pin :: Pin < & Self > , dyn_index : usize , order : sp :: TraversalOrder , visitor : sp :: ItemVisitorRefMut) -> sp :: VisitChildrenResult {
     ...
     impl r#App {
         pub fn new () -> core :: result :: Result < Self , slint :: PlatformError > {
             ...
             inner . globals . global_ColorSchemeSelector_19 . clone () . init (& inner) ;
             inner . globals . global_Palette_20 . clone () . init (& inner) ;
     ...
     # [allow (dead_code)] struct Globals_App {
         global_ColorSchemeSelector_19 : :: core :: pin :: Pin < sp :: Rc < InnerColorSchemeSelector_19 >> , global_Palette_20 : :: core :: pin :: Pin < sp :: Rc < InnerPalette_20 >> , global_StyleMetrics_21 : :: core :: pin :: Pin < sp :: Rc < InnerStyleMetrics_21 >> , }
     impl Default for Globals_App {
         fn default () -> Self {
             Self {
                 global_ColorSchemeSelector_19 : InnerColorSchemeSelector_19 :: new () , global_Palette_20 : InnerPalette_20 :: new () , global_StyleMetrics_21 : InnerStyleMetrics_21 :: new () , }
             }
         }
