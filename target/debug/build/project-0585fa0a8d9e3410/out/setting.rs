# [allow (non_snake_case)] # [allow (non_camel_case_types)] # [allow (clippy :: style)] # [allow (clippy :: complexity)] # [allow (unused_braces)] # [allow (clippy :: erasing_op)] # [allow (clippy :: approx_constant)] # [allow (clippy :: eq_op)] # [allow (clippy :: cmp_owned)] # [allow (clippy :: redundant_clone)] mod slint_generatedSetting {
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] struct InnerColorSchemeSelector_3 {
         r#dark_color_scheme : sp :: Property < bool > , root : sp :: OnceCell < sp :: VWeak < sp :: ComponentVTable , InnerSetting >> , }
     impl InnerColorSchemeSelector_3 {
         ...
         fn init (self : :: core :: pin :: Pin < sp :: Rc < Self >> , root : & sp :: VRc < sp :: ComponentVTable , InnerSetting >) {
             ...
             let _self = self_rc . as_ref () ;
             {
                 slint :: private_unstable_api :: set_property_binding ({
                     * & InnerColorSchemeSelector_3 :: FIELD_OFFSETS . r#dark_color_scheme }
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] struct InnerPalette_4 {
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin] struct InnerStyleMetrics_5 {
         root : sp :: OnceCell < sp :: VWeak < sp :: ComponentVTable , InnerSetting >> , }
     impl InnerStyleMetrics_5 {
         fn new () -> :: core :: pin :: Pin < sp :: Rc < Self >> {
             sp :: Rc :: pin (Self :: default ()) }
         fn init (self : :: core :: pin :: Pin < sp :: Rc < Self >> , root : & sp :: VRc < sp :: ComponentVTable , InnerSetting >) {
             # ! [allow (unused)] self . root . set (VRc :: downgrade (root)) ;
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin_drop] pub struct InnerSetting {
         r#root_1 : sp :: r#WindowItem , r#rectangle_2 : sp :: r#Rectangle , r#root_1_showsetting : sp :: Callback < () , () > , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ComponentVTable , InnerSetting >> , root : sp :: OnceCell < sp :: VWeak < sp :: ComponentVTable , InnerSetting >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , globals : Globals_Setting , window_adapter_ : sp :: OnceCell < sp :: Rc < dyn sp :: WindowAdapter >> , }
     impl InnerSetting {
         pub fn init (self_rc : sp :: VRcMapped < sp :: ComponentVTable , Self > , root : & sp :: VRc < sp :: ComponentVTable , InnerSetting > , tree_index : u32 , tree_index_of_first_child : u32) {
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerSetting :: FIELD_OFFSETS . r#root_1 }
                 + r#WindowItem :: FIELD_OFFSETS . r#background) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (slint :: Brush :: SolidColor (slint :: Brush :: SolidColor (if InnerColorSchemeSelector_3 :: FIELD_OFFSETS . r#dark_color_scheme . apply_pin (_self . root . get () . unwrap () . upgrade () . unwrap () . globals . global_ColorSchemeSelector_3 . as_ref ()) . get () {
             ...
             ({
                 * & InnerSetting :: FIELD_OFFSETS . r#rectangle_2 }
     ...
     impl r#Setting {
         pub fn new () -> core :: result :: Result < Self , slint :: PlatformError > {
             ...
             inner . globals . global_ColorSchemeSelector_3 . clone () . init (& inner) ;
             inner . globals . global_Palette_4 . clone () . init (& inner) ;
             inner . globals . global_StyleMetrics_5 . clone () . init (& inner) ;
         ...
         # [allow (dead_code)] pub fn invoke_showsetting (& self ,) -> () {
             ...
             ({
                 * & InnerSetting :: FIELD_OFFSETS . r#root_1_showsetting }
     ...
     # [allow (dead_code)] struct Globals_Setting {
         global_ColorSchemeSelector_3 : :: core :: pin :: Pin < sp :: Rc < InnerColorSchemeSelector_3 >> , global_Palette_4 : :: core :: pin :: Pin < sp :: Rc < InnerPalette_4 >> , global_StyleMetrics_5 : :: core :: pin :: Pin < sp :: Rc < InnerStyleMetrics_5 >> , }
     impl Default for Globals_Setting {
         fn default () -> Self {
             Self {
                 global_ColorSchemeSelector_3 : InnerColorSchemeSelector_3 :: new () , global_Palette_4 : InnerPalette_4 :: new () , global_StyleMetrics_5 : InnerStyleMetrics_5 :: new () , }
             }
         }
